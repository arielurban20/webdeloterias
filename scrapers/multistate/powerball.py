"""
Scraper oficial para Powerball usando NY Open Data.

Endpoint: https://data.ny.gov/resource/d6yy-54nr.json
Documentación: https://dev.socrata.com/foundry/data.ny.gov/d6yy-54nr
"""
...
_SOURCE_URL = "https://data.ny.gov/resource/d6yy-54nr.json"


class PowerballScraper:
    """Obtiene resultados de Powerball desde NY Open Data (fuente oficial)."""
    ...
    def _parse(self, row: dict) -> NormalizedDraw:
        ...
        bonus_number = row.get("powerball")
